                        ...
                        <div className="w-full max-w-sm">
                            ...
                            <div className="text-center mb-4 pt-5">
                                ...
                                <ul class="charts-css legend max-w-80 max-h-60">
                                  <h3>I'm Steven the Seagull, and I want to explore the world sustainably. Join me on my journey to reduce my carbon footprint! </h3>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative justify-center">
                      <div className="w-full max-w-sm">
                        <div className="space-x-20">
                          <img src="/map.jpeg" alt="map" className="max-h-100 min-w-140"/>
                        </div>
                        </div>
                    </div>
                    <div className="flex justify-center">
